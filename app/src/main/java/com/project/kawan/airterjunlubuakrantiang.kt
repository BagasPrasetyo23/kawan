...
class airterjunlubuakrantiang : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageList.add(SlideModel(R.drawable.d_rantiang1_x4))
        imageList.add(SlideModel(R.drawable.d_rantiang2_x4))
        imageList.add(SlideModel(R.drawable.d_rantiang3_x4))
